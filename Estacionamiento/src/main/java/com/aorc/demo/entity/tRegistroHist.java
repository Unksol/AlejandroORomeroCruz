...
@Entity
public class tRegistroHist implements Serializable {
	...
	public Long getIdRegistroHist() {
		return idRegistroHist;
	}

	public void setIdRegistroHist(Long idRegistroHist) {
		this.idRegistroHist = idRegistroHist;
	}
	...
	public String toString() {
		return "tRegistroHist [idRegistroHist=" + idRegistroHist + ", hrEntrada=" + hrEntrada + ", hrSalida=" + hrSalida
	...
	public int hashCode() {
		...
		result = prime * result + ((idRegistroHist == null) ? 0 : idRegistroHist.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		tRegistroHist other = (tRegistroHist) obj;
		if (activo == null) {
		...
		if (hrsTotal == null) {
			...
			return false;
		if (idRegistroHist == null) {
			if (other.idRegistroHist != null)
				return false;
		} else if (!idRegistroHist.equals(other.idRegistroHist))
			return false;
		if (sumCosto == null) {
